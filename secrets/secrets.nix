let
  ...
  # nixbook = "ssh-ed25519 ..."; # TODO: fill in from /etc/ssh/ssh_host_ed25519_key.pub after deploying there, then re-encrypt with `agenix -r`
  mario = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIIbtP3jOc+3FufWmuhPL3gMM0KQ8g1Jelm/bzORm7RRL mariofbarros.fsma@gmail.com";
in {
  "searxng-secret.env.age".publicKeys = [ nixBtw mario ];
}
